...
// pub async fn select_account_by_creds(db_tx: &mut DBTx<'_>, creds: Credentials) -> Result<Option<AccountSQL>> {
...
// pub async fn message_id_by_imap_uid(db_tx: &mut DBTx<'_>, account_id: i64, imap_uid: i64) -> Result<Option<i64>>
// {
//     Ok(sqlx::query!(
//         "
//         SELECT id
...
// pub async fn upd_messages(db_tx: &mut DBTx<'_>, msg: MessageSQL) -> Result<()> {
...
// pub async fn upd_message_parts(db_tx: &mut DBTx<'_>, message: MessageSQL, parts: Vec<(String, Vec<u8>)>) -> Result<()> {
...
// pub async fn upd_mailbox(db_tx: &mut DBTx<'_>, mb: MailboxSQL, cred_id: CredentialID) -> Result<()> {
