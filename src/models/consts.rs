...
pub const JITTER_VARIANCE: f64 = 0.4;
pub const RETRIES: usize = 10;
pub const ASSUMED_DOWNLOAD_SPEED: u32 = 20 * 1024 * 1024; // bits per second
pub const ASSUMED_LATENCY: u32 = 200; // ms
pub const MAX_IMAP_SESSIONS: usize = 5; // Just a hard coded limit :p
...
pub const MAX_LISTFETCH_SIZE: u32 = 1<<13; 
...
pub const MAX_PREFETCH_STRAT1_SIZE: u32 = 1<<19; 
pub const MAILBOX_INBOX_ASSUMED_SIZE: u32 = 1000; // Simply for an educated guess (average is 8000 apparently 😳)
pub const NETSOCK_REFRESH_INTERVAL: std::time::Duration = std::time::Duration::from_mins(3);
